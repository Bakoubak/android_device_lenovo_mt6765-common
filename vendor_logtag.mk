...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    persist.log.tag.WifiVendorHal=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.GPUAUX=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.RefBase=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.AidlConversion=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.AudioManager=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.MDP=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.ImgSensorDrv=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.isp_tuning_custom=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.MtkCam/P1NodeUtility=$(VENDOR_LOG_LEVEL_I) \
